...
<?php foreach($users as $user): ?> 
    <tr class="node <?php echo odd_even() ?>">
      <td class="user">
        <img src="http://www.gravatar.com/avatar.php?gravatar_id=<?php echo md5($user->email) ?>&amp;default=<?php echo urlencode('http://www.madebyfrog.com/user.png') ?>&amp;size=32" align="middle" alt="user icon" />
