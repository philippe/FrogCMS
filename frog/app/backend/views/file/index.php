...
<?php foreach ($files as $file): ?>
    <tr class="<?php echo odd_even(); ?>">
      ...
      <td>
        ...
        <a href="<?php echo get_url('file/delete/'.$dir.$file->name); ?>" onclick="return confirm('<?php echo __('Are you sure you wish to delete'); ?> <?php echo $file->name; ?>?');"><img src="images/icon-remove.gif" alt="remove icon" /></a>
      </td>
    </tr>
<?php endforeach; ?>
  </tbody>
...
<div id="popups">
  ...
  <div class="popup" id="rename-popup" style="display:none;">
      ...
      <form action="<?php echo get_url('file/rename'); ?>" method="post"> 
        <div>
